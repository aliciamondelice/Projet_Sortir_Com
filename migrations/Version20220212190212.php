 ...
 */
final class Version20220212190212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trip (id INT AUTO_INCREMENT NOT NULL, place_id INT NOT NULL, state_id INT NOT NULL, organizer_id INT NOT NULL, site_id INT NOT NULL, name VARCHAR(50) NOT NULL, informations LONGTEXT NOT NULL, starting_date DATETIME NOT NULL, ending_date DATETIME NOT NULL, duration INT NOT NULL, max_attendees INT NOT NULL, reason_cancel LONGTEXT DEFAULT NULL, INDEX IDX_7656F53BDA6A219 (place_id), INDEX IDX_7656F53B5D83CC1 (state_id), INDEX IDX_7656F53B876C4DDA (organizer_id), INDEX IDX_7656F53BF6BD1646 (site_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, site_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, surname VARCHAR(50) NOT NULL, phone VARCHAR(15) NOT NULL, is_admin TINYINT(1) DEFAULT NULL, is_active TINYINT(1) DEFAULT NULL, picture_link VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649F6BD1646 (site_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
